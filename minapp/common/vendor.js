(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["common/vendor"], {
            ...
            var v = function() {
                    ...
                    default.mark(function e(n, i, s) {
                        ...
                        default.wrap(function(e) {
                                ...
                                case 12:
                                    ...
                                    o.
                                default.prototype.appid = v.data.appid,
                                    o.
                                default.prototype.token = v.data.token,
                                    o.
                                default.prototype.uid = v.data.uid,
                                    o.
                                default.prototype.eject_poster = v.data.eject_poster,
                                    o.
                                default.prototype.poster = v.data.poster,
                                    v.data.qualified && (o.
                                default.prototype.qualified = v.data.qualified),
                                    v.data.subject && (o.
                                default.prototype.subject = v.data.subject),
                                    v.data.maxtime && (o.
                                default.prototype.maxtime = v.data.maxtime),
                                    v.data.recommends && (o.
                                default.prototype.recommends = v.data.recommends),
                                    v.data.rules && (o.
                                default.prototype.rules = v.data.rules),
                                    v.data.title && (o.
                                default.prototype.title = v.data.title),
                                    v.data.remarks && (o.
                                default.prototype.remarks = v.data.remarks),
                                    v.data.appstartlogo && (o.
                                default.prototype.appstartlogo = v.data.appstartlogo),
                                    v.data.apppasslogo && (o.
                                default.prototype.apppasslogo = v.data.apppasslogo),
                                    t.hideLoading(),
                                    e.next = 37;
                                    break;
                                case 34:
                ...
                },
                {
                    ...
                    value: function(t) {
                        ...
                        var n = t.data,
                        r = n.data;
                        return r && (e.serverCode = n.code, e.message = r.message, e.serverData = r),
                        e
                    }
                },
                {
    ...
    default = void 0;
        ...
        function P(t, e) {
            Object.keys(e).forEach(function(n) { - 1 !== k.indexOf(n) && y(e[n]) && (t[n] = S(t[n], e[n]))
            })
        }
        function D(t, e) {
            t && e && Object.keys(e).forEach(function(n) { - 1 !== k.indexOf(n) && y(e[n]) && E(t[n], e[n])
            })
        }
        function T(t, e) {
        ...
        function q(t, e) {
            ...
            var r = A[t];
            return r && Array.isArray(r.returnValue) && n.push.apply(n, f(r.returnValue)),
        ...
        at = {
            args: function(t) {
                ...
                if (!isNaN(e)) {
                    ...
                    if (Array.isArray(n)) {
                        var r = n.length;
                        if (r) return e < 0 ? e = 0 : e >= r && (e = r - 1),
                        e > 0 ? (t.current = n[e], t.urls = n.filter(function(t, r) {
                            return ! (r < e) || t !== n[e]
                        })) : t.current = n[0],
                        {
                            indicator: !1,
        ...
        function pt(t, e) {
            ...
            if (g(e)) {
                ...
                for (var a in y(n) && (n = n(e, i) || {}), e) if (m(n, a)) {
                    var s = n[a];
                    y(s) && (s = s(e[a], e, i)),
                    s ? _(s) ? i[s] = e[a] : g(s) && (i[s.name ? s.name: a] = s.value) : console.warn("微信小程序 ".concat(t, "暂不支持").concat(a))
                } else - 1 !== ft.indexOf(a) ? i[a] = lt(t, e[a], r) : o || (i[a] = e[a]);
                return i
            }
            return y(e) && (e = lt(t, e, r)),
            e
        }
        function ht(t, e, n) {
            var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
            return y(st.returnValue) && (e = st.returnValue(t, e)),
            pt(t, e, n, {},
            r)
        }
        function dt(t, e) {
        ...
        function Ut(t, e) {
            ...
            return e = e.
        default || e,
            y(e) ? (n = e, e = n.extendOptions) : n = t.extend(e),
            [n, e]
        }
        function Mt(t, e) {
        ...
        function Bt(t, e) {
            ...
            return g(n) || (n = {}),
            Object.keys(r).forEach(function(t) { - 1 !== e.__lifecycle_hooks__.indexOf(t) || m(n, t) || (n[t] = r[t])
            }),
            n
        }
        ...
        function zt(t, e) {
            ...
            return Array.isArray(n) && n.forEach(function(t) {
                ...
                "uni://form-field" === t && (Array.isArray(i) ? (i.push("name"), i.push("value")) : (i["name"] = {
                    type: String,
                default:
                    ""
                },
        ...
        function Wt(t) {
            ...
            t.target = t.target || {},
            m(t, "detail") || (t.detail = {}),
            g(t.detail) && (t.target = Object.assign({},
            t.target, t.detail)),
            t
        }
        function Kt(t, e) {
            ...
            return e.forEach(function(e) {
                ...
                if (r || "undefined" !== typeof o) {
                    ...
                    }) : console.error("v-for 暂不支持循环数据：", s) : n = s[o],
        ...
        function oe(t, e) {
            ...
            o = e.initRefs;
            t.$options.store && (r.
        default.prototype.$store = t.$options.store),
            r.
        ...
        "undefined" !== typeof Proxy ? we = new Proxy({},
        {
            ...
            we[t] = X(t, jt[t])
        }), Object.keys(wx).forEach(function(t) { (m(wx, t) || m(st, t)) && (we[t] = X(t, dt(t, wx[t])))
        })),
        wx.createApp = he,
        wx.createPage = me,
        wx.createComponent = be;
        var $e = we,
        Oe = $e;
        e.
    default = Oe
 ...
 */
            ...
            var ot = function() {
                return void 0 === J && (J = !K && !X && "undefined" !== typeof t && (t["process"] && "server" === t["process"].env.VUE_ENV)),
                J
            },
            ...
            function ht() {
                ...
                lt.SharedObject.target = lt.SharedObject.targetStack[lt.SharedObject.targetStack.length - 1]
            }
            ...
            lt.SharedObject = "undefined" !== typeof SharedObject ? SharedObject: {},
            ...
            var xt = function(t) {
                ...
                this.vmCount = 0,
                H(t, "__ob__", this),
                Array.isArray(t) ? (W ? t.push !== t.__proto__.push ? St(t, bt, $t) : At(t, bt) : St(t, bt, $t), this.observeArray(t)) : this.walk(t)
            };
            function At(t, e) {
                t.__proto__ = e
            }
            ...
            function jt(t, e) {
                var n;
                if (u(t) && !(t instanceof dt)) return b(t, "__ob__") && t.__ob__ instanceof xt ? n = t.__ob__: Ot && !ot() && (Array.isArray(t) || f(t)) && Object.isExtensible(t) && !t._isVue && (n = new xt(t)),
                e && n && n.vmCount++,
                n
            }
            function Et(t, e, n, r, o) {
                ...
                if (!a || !1 !== a.configurable) {
                    ...
                    Object.defineProperty(t, e, {
                        ...
                        get: function() {
                            var e = s ? s.call(t) : n;
                            return lt.SharedObject.target && (i.depend(), c && (c.dep.depend(), Array.isArray(e) && Tt(e))),
                            e
                        },
                        set: function(e) {
                            var r = s ? s.call(t) : n;
            ...
            function It(t, e) {
                ...
                "__ob__" !== n && (r = t[n], o = e[n], b(t, n) ? r !== o && f(r) && f(o) && It(r, o) : Pt(t, n, o));
                return t
            }
            function Rt(t, e, n) {
                return n ?
            ...
            function Ft(t, e, n) {
                if ("function" === typeof e && (e = e.options), Mt(e, n), Vt(e, n), Bt(e), !e._base && (e.extends && (t = Ft(t, e.extends, n)), e.mixins)) for (var r = 0,
                o = e.mixins.length; r < o; r++) t = Ft(t, e.mixins[r], n);
                var i, a = {};
                for (i in t) s(i);
            ...
            function zt(t, e, n, r) {
                ...
                if (s > -1) if (i && !b(o, "default")) a = !1;
                    ...
                    var u = Kt(String, o.type); (u < 0 || s < u) && (a = !0)
                }
                if (void 0 === a) {
                    a = Gt(r, o, t);
                    var c = Ot;
            ...
            function Kt(t, e) {
                ...
                for (var n = 0,
                r = e.length; n < r; n++) if (Wt(e[n], t)) return n;
                return - 1
            }
            function Xt(t, e, n) {
                pt();
            ...
            function de(t, e, n, o, a, s) {
                ...
                f = e[u],
                l = pe(u),
                r(c) || (r(f) ? (r(c.fns) && (c = t[u] = he(c, s)), i(l.once) && (c = t[u] = a(l.name, c, l.capture)), n(l.name, c, l.capture, l.passive, l.params)) : c !== f && (f.fns = c, t[u] = f));
            ...
            function be(t, e) {
                ...
                r(a) || "boolean" === typeof a || (u = f.length - 1, c = f[u], Array.isArray(a) ? a.length > 0 && (a = be(a, (e || "") + "_" + n), me(a[0]) && me(c) && (f[u] = _t(c.text + a[0].text), a.shift()), f.push.apply(f, a)) : s(a) ? me(c) ? f[u] = _t(c.text + a) : "" !== a && f.push(_t(a)) : me(a) && me(c) ? f[u] = _t(c.text + a.text) : (i(t._isVList) && o(a.tag) && r(a.key) && o(e) && (a.key = "__vlist" + e + "_" + n + "__"), f.push(a)));
                return f
            }
            function we(t) {
            ...
            function Se(t, e, n) {
                var r = function() {
                    ...
                    return t = t && "object" === typeof t && !Array.isArray(t) ? [t] : ge(t),
            ...
            function He(t, e, r, o, a) {
                ...
                this.injections = Oe(c.inject, o),
                this.slots = function() {
                    return u.$slots || Ae(t.scopedSlots, u.$slots = ke(r, o)),
                    u.$slots
                },
                ...
                f && (this.$options = c, this.$slots = this.slots(), this.$scopedSlots = Ae(t.scopedSlots, this.$slots)),
            ...
            function ze(t, e, r, i, a) {
                ...
                else o(r.attrs) && Je(u, r.attrs),
                o(r.props) && Je(u, r.props);
            ...
            var We = {
                ...
                insert: function(t) {
                    ...
                    t.data.keepAlive && (e._isMounted ? Fn(n) : En(n, !0))
                },
                destroy: function(t) {
            ...
            function on(t, e, n, r, i) {
                ...
                var a, s, u; (Array.isArray(r) && "function" === typeof r[0] && (n = n || {},
                n.scopedSlots = {
                default:
                    r[0]
                },
            ...
            function sn(t) {
                u(t.style) && fe(t.style),
                u(t.class) && fe(t.class)
            }
            function un(t) {
                t._vnode = null,
                t._staticTrees = null;
            ...
            function ln(t) {
                ...
                t.prototype._render = function() {
                    ...
                    r = n.render,
                    o = n._parentVnode;
                    o && (e.$scopedSlots = Ae(o.data.scopedSlots, e.$slots, e.$scopedSlots)),
                    e.$vnode = o;
                    try {
                        fn = e,
            ...
            function Sn(t, e, r, o, i) {
                ...
                if (t.$options._parentVnode = o, t.$vnode = o, t._vnode && (t._vnode.parent = o), t.$options._renderChildren = i, t.$attrs = o.data.attrs || n, t.$listeners = r || n, e && t.$options.props) {
                    kt(!1);
                    for (var f = t._props,
                    l = t.$options._propKeys || [], p = 0; p < l.length; p++) {
                        var h = l[p],
                        d = t.$options.props;
                        f[h] = zt(h, d, e, t)
                    }
                ...
                wn(t, r, v),
                c && (t.$slots = ke(i, o.context), t.$forceUpdate())
            }
            function jn(t) {
            ...
            function Dn(t, e) {
                ...
                r = e + " hook";
                if (n) for (var o = 0,
                i = n.length; o < i; o++) Yt(n[o], t, null, t, r);
            ...
            Jn = function(t, e, n, r, o) {
                ...
                this.expression = "",
                "function" === typeof e ? this.getter = e: (this.getter = G(e), this.getter || (this.getter = C)),
            ...
            function Xn(t) {
                t._watchers = [];
                var e = t.$options;
                e.props && Yn(t, e.props),
                e.methods && ir(t, e.methods),
                e.data ? Qn(t) : jt(t._data = {},
                !0),
                e.computed && er(t, e.computed),
                e.watch && e.watch !== nt && ar(t, e.watch)
            }
            function Yn(t, e) {
            ...
            function Qn(t) {
                ...
                e = t._data = "function" === typeof e ? Zn(e, t) : e || {},
                f(e) || (e = {});
                var n = Object.keys(e),
                r = t.$options.props,
            ...
            function er(t, e) {
                ...
                for (var o in e) {
                    ...
                    0,
                    r || (n[o] = new Jn(t, a || C, C, tr)),
                    o in t || nr(t, o, i)
                }
            }
            function nr(t, e, n) {
                var r = !ot();
                "function" === typeof n ? (Wn.get = r ? rr(e) : or(n), Wn.set = C) : (Wn.get = n.get ? r && !1 !== n.cache ? rr(e) : or(n.get) : C, Wn.set = n.set || C),
            ...
            function fr(t) {
                t.prototype._init = function(t) {
                    ...
                    e._uid = cr++,
                    e._isVue = !0,
                    t && t._isComponent ? lr(e, t) : e.$options = Ft(pr(e.constructor), t || {},
                    e),
                    e._renderProxy = e,
                    e._self = e,
                    xn(e),
                    ...
                    un(e),
                    Dn(e, "beforeCreate"),
                    "mp-toutiao" !== e.mpHost && $e(e),
                    Xn(e),
                    "mp-toutiao" !== e.mpHost && we(e),
                    "mp-toutiao" !== e.mpHost && Dn(e, "created"),
            ...
            function pr(t) {
                ...
                if (t.super) {
                    ...
                    if (n !== r) {
                        ...
                        e = t.options = Ft(n, t.extendOptions),
            ...
            Ar = {
                ...
                default,
                    ...
                    if (n) {
                        ...
                        u[f] ? (e.componentInstance = u[f].componentInstance, g(c, f), c.push(f)) : (u[f] = e, c.push(f), this.max && c.length > parseInt(this.max) && kr(u, c[0], c, this._vnode)),
                        e.data.keepAlive = !0
                    }
                    return e || t && t[0]
                }
            ...
            function Ur(t) {
                ...
                Array.isArray(t.$options.behaviors) && -1 !== t.$options.behaviors.indexOf("uni://form-field") && (e["name"] = t.name, e["value"] = t.value),
            ...
            var Mr = function(t, e) {
                ...
                if (null !== e && ("page" === this.mpType || "component" === this.mpType)) {
                    ...
                    Object.keys(a).length ? (Object({
                        ...
                        VUE_APP_PLATFORM: "mp-weixin",
                        BASE_URL: "/"
                    }).VUE_APP_DEBUG && console.log("[" + +new Date + "][" + (r.is || r.route) + "][" + this._uid + "]差量更新", JSON.stringify(a)), this.__next_tick_pending = !0, r.setData(a,
                    function() {
            ...
            function Br(t, e, n) {
                ...
                "app" === t.mpType && (t.$options.render = Vr),
                t.$options.render || (t.$options.render = Vr),
                "mp-toutiao" !== t.mpHost && Dn(t, "beforeMount");
                var r = function() {
            ...
            function Gr(t) {
                for (var e, n = "",
                r = 0,
                i = t.length; r < i; r++) o(e = zr(t[r])) && "" !== e && (n && (n += " "), n += e);
                return n
            }
            function Jr(t) {
                var e = "";
            ...
            function Yr(t, e) {
                var n = e.split("."),
                r = n[0];
                return 0 === r.indexOf("__$n") && (r = parseInt(r.replace("__$n", ""))),
                1 === n.length ? t[r] : Yr(t[r], n.slice(1).join("."))
            }
            function Qr(t) {
                ...
                t.prototype.__init_injections = $e,
                t.prototype.__call_hook = function(t, e) {
                    ...
                    i = t + " hook";
                    if (o) for (var a = 0,
                    s = o.length; a < s; a++) r = Yt(o[a], n, e ? [e] : null, n, i);
                    return n._hasHookEvent && n.$emit("hook:" + t),
                    ht(),
                    r
                },
            ...
            function to(t) {
                ...
                t.extend = function(t) {
                    t = t || {};
                    var n = t.methods;
                    return n && Object.keys(n).forEach(function(e) { - 1 !== Zr.indexOf(e) && (t[e] = n[e], delete n[e])
                    }),
                    e.call(this, t)
                };
            ...
            l(e, null, [{
                ...
                default.mark(function t() {
                    ...
                    default.wrap(function(t) {
                            ...
                            case 0:
                                return e = "".concat(this.baseUrl, "/stats"),
                                t.next = 3,
                                this.get(e, {
                                    version: o.
                                default.prototype.version
            ...
            },
            {
                ...
                default.mark(function t() {
                    ...
                    default.wrap(function(t) {
                            while (1) switch (t.prev = t.next) {
                            case 0:
                                return e = "".concat(this.baseUrl, "/user/sharelog"),
                                t.next = 3,
                                this.get(e, {
                                    version: o.
                                default.prototype.version
            ...
            },
            {
                ...
                default.mark(function t() {
                    ...
                    default.wrap(function(t) {
                            while (1) switch (t.prev = t.next) {
                            case 0:
                                return e = "".concat(this.baseUrl, "/user/problem"),
                                t.next = 3,
                                this.get(e, {
                                    subject: o.
            ...
            },
            {
                ...
                default.mark(function t(e) {
                    ...
                    default.wrap(function(t) {
                            while (1) switch (t.prev = t.next) {
                            case 0:
                                return n = "".concat(this.baseUrl, "/user/questions"),
                                t.next = 3,
                                this.get(n, {
                                    id: e,
                                    version: o.
            ...
            },
            {
                ...
                default.mark(function t(e) {
                    ...
                    default.wrap(function(t) {
                            while (1) switch (t.prev = t.next) {
                            case 0:
                                return n = "".concat(this.baseUrl, "/user/info"),
                                t.next = 3,
                                this.get(n, {
                                    id: e,
                                    version: o.
            ...
            },
            {
                ...
                default.mark(function t(e) {
                    ...
                    default.wrap(function(t) {
                            while (1) switch (t.prev = t.next) {
                            case 0:
                                return n = "".concat(this.baseUrl, "/user/post"),
                                t.next = 3,
                                this.post(n, e);
                            case 3:
                                return t.abrupt("return", t.sent);
    ...
    "7a8b": function(t, e, n) {
        ...
        t.exports = {
            ...
            maxtime: 100,
            version: "1.0.0",
            base_api: "https://yuwdt.readfollow.com",
    ...
    "921b": function(t, e, n) {
        "use strict"; (function(t) {
            ...
            k = function() {
                var e = "";
                return "wx" !== O() && "qq" !== O() || t.canIUse("getAccountInfoSync") && (e = t.getAccountInfoSync().miniProgram.appId || ""),
                e
            },
            x = function() {
            ...
            A = function() {
                var t = O(),
                e = "";
                return "n" === t && (e = plus.runtime.channel),
                e
            },
            S = function(e) {
                var n = O(),
            ...
            P = function() {
                ...
                n = 0;
                return e ? n = e: (n = $(), t.setStorageSync(j, n), t.removeStorageSync(E)),
                n
            },
            D = function() {
            ...
            R = function() {
                return C = $(),
                "n" === O() && t.setStorageSync(T, $()),
                C
            },
            N = function() {
                return I = $(),
                "n" === O() && (C = t.getStorageSync(T)),
                I - C
            },
            ...
            G = function(t) {
                ...
                return t._query = "",
                "bd" === O() ? r.$mp && r.$mp.page.is + i: r.$scope && r.$scope.route + i || r.$mp && r.$mp.page.route + i
            },
            J = function(t) {
        ...
        default || n("497d"),
            ...
            Q = function() {
                ...
                },
                {
                    ...
                    value: function() {
                        var t = G(this),
                        e = z();
                        if (this._navigationBarTitle.config = K && K.pages[e] && K.pages[e].titleNView && K.pages[e].titleNView.titleText || K && K.pages[e] && K.pages[e].navigationBarTitleText || "", this.__licationShow) return B(),
                        this.__licationShow = !1,
                        void(this._lastPageRoute = t);
                        F(),
                        this._lastPageRoute = t;
                        var n = H("page");
                        if (n.overtime) {
                            var r = {
                                path: this._lastPageRoute,
                ...
                },
                {
                    ...
                    value: function(t) {
                        ...
                        this.statData.t = $(),
                        this.statData.sc = S(t.scene),
                        this.statData.fvts = P(),
                        this.statData.lvts = D(),
                        this.statData.tvc = q(),
                        "n" === O() ? this.getProperty() : this.getNetworkInfo()
                    }
                },
                {
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        X.getLocation ? t.getLocation({
                            ...
                            geocode: !0,
                            success: function(t) {
                                t.address && (e.statData.cn = t.address.country, e.statData.pn = t.address.province, e.statData.ct = t.address.city),
                ...
                },
                {
                    ...
                    value: function(e, n) {
                        ...
                        if ("n" === O() && (a = t.getStorageSync("__UNI__STAT__DATA") || {}), a[e.lt] || (a[e.lt] = []), a[e.lt].push(e), "n" === O() && t.setStorageSync("__UNI__STAT__DATA", a), !(N() < y) || n) {
                            ...
                            "n" === O() && (s = t.getStorageSync("__UNI__STAT__DATA")),
                            R();
                            var u = [],
                            c = [],
                            f = [],
                            ...
                            this._reportingRequestData = {},
                            "n" === O() && t.removeStorageSync("__UNI__STAT__DATA"),
                            "h5" !== e.ut ? "n" !== O() || "a" !== this.statData.p ? this._sendRequest(d) : setTimeout(function() {
                                r._sendRequest(d)
                            },
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        t.request({
                            ...
                            data: e,
                            success: function() {},
                            fail: function(t) {++n._retry < 3 && setTimeout(function() {
                                    n._sendRequest(e)
                                },
                                1e3)
                            }
            ...
            Z = function(e) {
                function n() {
                    var e;
                    return u(this, n),
                    e = r(this, i(n).call(this)),
                    e.instance = null,
                    "function" === typeof t.addInterceptor && (e.addInterceptorInit(), e.interceptLogin(), e.interceptShare(!0), e.interceptRequestPayment()),
                    e
                }
                return a(n, e),
                f(n, null, [{
                ...
                },
                {
                    ...
                    value: function(t) {
                        this.self = t,
                        J(t) ? this._pageShow(t) : this._applicationShow(t)
                    }
                },
                {
                    key: "ready",
                ...
                },
                {
                    ...
                    value: function(t) {
                        this.self = t,
                        J(t) ? this._pageHide(t) : this._applicationHide(t, !0)
                    }
                },
                {
                    key: "error",
    ...
    "96cf": function(t, e) { !
        function(e) {
            ...
            if (f) c && (t.exports = f);
                ...
                f = e.regeneratorRuntime = c ? t.exports: {},
                f.wrap = b;
                ...
                O.prototype = m.constructor = k,
                k.constructor = O,
                k[u] = O.displayName = "GeneratorFunction",
            ...
            function T(t) {
                if (t) {
                    ...
                    if (!isNaN(t.length)) {
                        var r = -1,
                        i = function e() {
                            while (++r < t.length) if (o.call(t, r)) return e.value = t[r],
                            e.done = !1,
                            e;
                            return e.value = n,
                            e.done = !0,
